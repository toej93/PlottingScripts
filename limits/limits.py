...
class LimitFigure:
    ...
    def add_experiment(self, name):
        if 'ice_cube' in name:
            ...
            if self.e_power==1:
                self.ax.annotate('IceCube',
                                 xy=(1.5e7, 2.5e-15), xycoords='data',
        ...
        if name=='grand_10k':
            ...
            if self.e_power==1:
                self.ax.annotate('ANITA I - IV',
                                 xy=(1.5e9, 8e-15*self.e_bins), xycoords='data',
            ...
            if self.e_power==1:
                self.ax.annotate('Auger',
                                 ...
                                 xy=(4e7, 5e-15*self.e_bins), xycoords='data',
                                 horizontalalignment='left', color='forestgreen', rotation=0, fontsize=12)


        elif name=='arianna':
            energy, flux, _, _ = self.get_data('sensitivities/arianna.txt')
            ...
            if self.e_power==1:
                self.ax.annotate(' ',
                                 xy=(2.5e8, 1.6e-14*self.e_bins), xycoords='data',
                                 horizontalalignment='left', color='black', rotation=-50, fontsize=12)
                # self.ax.annotate('ARA (2x4yr)',
